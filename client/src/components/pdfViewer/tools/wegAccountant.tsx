    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="space-y-3">
                <h3 className="text-sm font-semibold text-gray-700">Accountant</h3>
                <div className={cn("flex flex-col gap-1", isMissing("accountantName") && "ring-2 ring-amber-400 rounded-md p-1")}>
