...
export function PropertyDetailsStep({ onNext, onBack }: PropertyDetailsStepProps) {
    return (
        <Card className="w-full pb-0 max-w-2xl">
            ...
            <CardContent className="flex flex-col gap-7">
                <div className="space-y-2">
                    ...
                    <Input className="p-5" id="propertyName" defaultValue="Sunset Apartments" placeholder="e.g. Sunset Apartments" />
                </div>

                <div className="space-y-2">
                    <Label>Registered property address</Label>
                    <Input defaultValue="Main Street 123" placeholder="Street" className="mb-2 p-5" />
                    <div className="flex gap-2">
                        <Input defaultValue="10115" placeholder="Postcode" className="w-1/3 p-5" />
                        <Input defaultValue="Berlin" placeholder="City" className="w-2/3 p-5" />
                    </div>
                </div>
            </CardContent>
            <CardFooter className="flex gap-4 bg-muted pt-4 pb-6 border-t mt-2">
                ...
                <Button onClick={onNext} className="grow text-lg h-10 cursor-pointer">
                    Continue
                </Button>
            </CardFooter>
        </Card>
